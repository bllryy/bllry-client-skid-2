...
import me.lily.bllry.mixins.accessors.*;
...
public class ShaderManager implements IMinecraft {
    ...
    public void render(int renderMode, float opacity) {
        PostEffectProcessor shader = mc.getShaderLoader().loadPostEffect(Identifier.of(Bllry.MOD_ID, "outline"), DefaultFramebufferSet.MAIN_ONLY);

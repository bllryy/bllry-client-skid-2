...
import me.lily.bllry.mixins.accessors.ClientPlayerInteractionManagerAccessor;
...
public class MaceAuraModule extends Module {
    ...
    public void onPlayerUpdate(PlayerUpdateEvent event) {
        ...
        if(rotate.getValue()) Bllry.ROTATION_MANAGER.rotate(RotationUtils.getRotations(target), this);

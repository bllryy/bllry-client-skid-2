...
public class Button implements IMinecraft {
    ...
    public void playClickSound() {
        if(Bllry.MODULE_MANAGER.getModule(ClickGuiModule.class).sounds.getValue()) mc.getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.0f));
    }
}

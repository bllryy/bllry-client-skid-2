...
import me.lily.bllry.modules.impl.core.ColorModule;
...
public class ColorButton extends Button {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if(open) {
            ...
            Renderer2D.renderOutline(context.getMatrices(), getX() + getWidth() - getPadding() - 9, getY() + offset, getX() + getWidth() - getPadding() - 1, getY() + offset + colorWidth, outlineColor);
            ...
            Renderer2D.renderOutline(context.getMatrices(), getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + colorWidth, outlineColor);
            ...
            Renderer2D.renderOutline(context.getMatrices(), getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + 8, outlineColor);
            ...
            Bllry.FONT_MANAGER.drawTextWithShadow(context, "Copy", getX() + getPadding() + (getWidth()/4) - 1 - Bllry.FONT_MANAGER.getWidth("Copy")/2, getY() + offset + 2, Color.WHITE);
            ...
            Bllry.FONT_MANAGER.drawTextWithShadow(context, "Paste", getX() + (getWidth()/2) + (getWidth()/4) - 1 - Bllry.FONT_MANAGER.getWidth("Paste")/2, getY() + offset + 2, Color.WHITE);
            ...
            Bllry.FONT_MANAGER.drawTextWithShadow(context, "Sync", getX() + (getWidth()/2) - Bllry.FONT_MANAGER.getWidth("Sync")/2, getY() + offset + 2, Color.WHITE);
            ...
            Bllry.FONT_MANAGER.drawTextWithShadow(context, "Rainbow", getX() + (getWidth()/2) - Bllry.FONT_MANAGER.getWidth("Rainbow")/2, getY() + offset + 2, Color.WHITE);
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if(button == 0) {
            ...
            if(hoveringCopy) {
                Bllry.CLICK_GUI.setColorClipboard(setting.getValue().getColor());
                playClickSound();
            }
            if(hoveringPaste && Bllry.CLICK_GUI.getColorClipboard() != null) {
                setting.setColor(Bllry.CLICK_GUI.getColorClipboard());
                hsb = Color.RGBtoHSB(setting.getColor().getRed(), setting.getColor().getGreen(), setting.getColor().getBlue(), null);
                playClickSound();
            }
            if(setting != Bllry.MODULE_MANAGER.getModule(ColorModule.class).color && hoveringSync) {

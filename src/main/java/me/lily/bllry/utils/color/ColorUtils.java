package me.lily.bllry.utils.color;
...
public class ColorUtils {
    ...
    public static Color getGlobalColor() {
        return Bllry.MODULE_MANAGER.getModule(ColorModule.class).color.getColor();
    }

    public static Color getGlobalColor(int alpha) {
        return getColor(Bllry.MODULE_MANAGER.getModule(ColorModule.class).color.getColor(), alpha);
    }
    ...
    public static Color getRainbow(int alpha) {
        return getRainbow(Bllry.MODULE_MANAGER.getModule(ColorModule.class).rainbowSpeed.getValue().longValue(), Bllry.MODULE_MANAGER.getModule(ColorModule.class).rainbowSaturation.getValue().floatValue() / 100.0f, Bllry.MODULE_MANAGER.getModule(ColorModule.class).rainbowBrightness.getValue().floatValue() / 100.0f, alpha);
    }

    public static Color getOffsetRainbow(int alpha, long index) {
        return getRainbow(Bllry.MODULE_MANAGER.getModule(ColorModule.class).rainbowSpeed.getValue().longValue(), Bllry.MODULE_MANAGER.getModule(ColorModule.class).rainbowSaturation.getValue().floatValue() / 100.0f, Bllry.MODULE_MANAGER.getModule(ColorModule.class).rainbowBrightness.getValue().floatValue() / 100.0f, alpha, index);
    }
    ...
    public static Color getOffsetWave(Color color, long index) {
        return getWave(color, Bllry.MODULE_MANAGER.getModule(ColorModule.class).rainbowSpeed.getValue().longValue(), 255, index);
    }
    ...
    public static Color getPulse(Color color, long speed) {
        ...
        double sin = Math.sin(2 * Math.PI * (speed/20f) * ((System.currentTimeMillis() - Bllry.UPTIME)/1000f));
